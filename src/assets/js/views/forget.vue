...
<template>
	<div class="forget">
		...
		<h1 class="logintitle">寻真溯源系统 验证重置密码</h1>
		<img src="/public/images/forget.png" class="main-bg">
		...
		<div class="logincontent">
				...
				<div class="form">
					<el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="demo-ruleForm" v-if="!formCheck">
					...
					<el-form :model="ruleForm2" :rules="rules2" ref="ruleForm2" class="demo-ruleForm" v-if="formCheck">
