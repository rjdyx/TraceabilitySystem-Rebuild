...
export default[{
    name: '基础信息管理',
    key: 'basic',
    childrenKey: ['category', 'operate', 'expert', 'client', 'supplier', 'product'],
    ...
    ]},
{
    name: '养殖管理',
    key: 'beast',
    childrenKey: ['basic', 'breed', 'fodderuse', 'disease', 'detection', 'detect', 'clean', 'dispose', 'come', 'plan'],
    src: '/public/images/plant.png',
    children: [{
...
},
{
    name: '种植管理',
    key: 'plant',
    childrenKey: ['basic', 'cultivate', 'farming', 'plan', 'harvest'],
...
},
{
    name: '销售管理',
    key: 'sell',
    childrenKey: ['repertory', 'storage', 'order'],
...
},
{
    name: '系统管理',
    key: 'system',
    childrenKey: ['company', 'user', 'log', 'statement', 'custom'],
