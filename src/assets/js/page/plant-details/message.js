...
export default {
    ...
    planBreedBatch: {
        ...
        theads: ['养殖计划批次号', '计划开始日期', '计划结束日期', '操作类型', '安排人员', '备注'],
        protos: ['serial', 'date', 'end_date', 'type', 'operate_name', 'memo'],
        changeDataArr: [{type: {'饲养': 'fodderuse', '检测': 'detects'}}],
        afterAdd: {fodderuse: {name: '饲料名称', name2: '添加剂名称', amount: '喂养量', way: '喂养方式'}, detects: {name: '检测项目名称', conent: '检测内容', department: '检测部门', result: '检测结果', expert_name: '指导专家'}},
        url: 'plan',
        tabList: [{
            url: 'breed-plan',
            tab: '养殖批次信息',
    ...
    planRfidBatch: {
        ...
        theads: ['养殖计划批次号', '计划开始日期', '计划结束日期', '操作类型', '安排人员', '备注'],
        protos: ['serial', 'date', 'end_date', 'type', 'operate_name', 'memo'],
        afterAdd: {disease: {name: '兽药名称', desc: '病情描述', amount: '用药量', way: '治疗方式', expert_name: '指导专家'}, detection: {name: '检疫项目名称', content: '检疫内容', result: '检疫结果', check: '审批人', expert_name: '指导专家'}},
    ...
    planSerial: {
        ...
        theads: ['计划批次号', '计划开始日期', '计划结束日期', '操作类型', '安排人员', '备注'],
        protos: ['serial', 'date', 'end_date', 'type', 'operate_name', 'memo'],
        changeDataArr: [{type: {'施肥': 'fertilize', '检测': 'detect', '田间': 'farming', '施药': 'spray', '采收': 'harvest'}}],
        afterAdd: {fertilize: {name: '肥料名称', amount: '施肥量', way: '喂养方式', expert_name: '指导专家'}, harvest: {name: '种植批次', department: '入库部门', name2: '存放位置'}, farming: {expert_name: '指导专家', content: '操作内容', way: '操作方法'}, spray: {name: '农药名称', amount: '施药量', way: '施药方式', concentration: '浓度', safety: '安全隔离期（天）', expert_name: '指导专家'}, detect: {name: '检测项目名称', conent: '检测内容', department: '检测部门', result: '检测结果', expert_name: '指导专家'}},
        url: 'plan',
        tabList: [{
            url: 'cultivate-plan',
            tab: '种植批次计划信息',
