...
export default {
    ...
    teaOrderBatch: {
        ...
        tabList: [{
            ...
            tab: '出库产品信息',
            searchPlaceholder: '请输入茶叶品种进行搜索',
            headList: ['茶叶品种', '数量', '单位', '规格', '备注信息'],
            protos: ['tea_name', 'amount', 'unit', 'specification', 'memo'],
            prinftBottom: ['合计'],
            prinftBottomProtos: [''],
            hiddeEdit: true,
            searchText: true,
            ...
            newComponent: [{
                ...
                selectInit2: [{value: '', label: '采制批次选择'}],
                popNumber2: [0],
                components: [{
                    name: 'harvest_id',
                    type: 'select',
    ...
    invoicesOrderBatch: {
        ...
        tab: '毛茶入库管理',
        printShow: true,
        theads: ['入库单批次号', '出库仓库名', '入库仓库名', '入库日期', '操作人（制票人）', '送货人', '提货人', '备注'],
        protos: ['serial', 'store_name', 'storeroom_name', 'date', 'operate', 'deliveryman', 'consignee', 'memo'],
        filter: [0, 7],
        url: 'invoices-order',
        odd: '毛茶入库单',
        tabList: [{
    ...
    pickingListBatch: {
        ...
        tabList: [{
            ...
            tab: '领料单产品信息',
            searchPlaceholder: '请输入茶叶品种进行搜索',
            headList: ['茶叶品种', '规格型号', '任务单号', '基本单位名称', '基本单位应发数量', '基本单位实发数量', '对象成本组', '单位', '实发数量', '库存数量', '备注'],
            protos: ['tea_name', 'specification', 'productive_task_serial', 'basic_unit', 'basic_recei_number', 'basic_real_number', 'object_arr', 'unit', 'real_number', 'store_number', 'memo'],
            hiddeEdit: true,
            searchText: true,
            ...
            newComponent: [{
                ...
                components: [{
                    ...
                    getType: 'string',
                    arrName: 'tea_order_product_id',
                    table: 'tea_order_products',
                    rule: {required: true, trigger: 'blur', message: '请选择毛茶入库单', type: 'number'},
                    options: []
                },
                {
                    name: 'tea_order_product_id',
                    type: 'select',
                    component: null,
                    isNull: false,
                    label: '茶叶品种',
    ...
    storageOrderBatch: {
        ...
        tabList: [{
            ...
            newComponent: [{
                tab: '新建入库产品信息',
                selectUrl2: [['picking_lists', 'id', 'serial', true], ['products', 'id', 'name', true]],
                selectInit2: [{value: '', label: '领料单选择'}, {value: '', label: '包装产品选择'}],
                popNumber2: [0, 2],
                assocPosition: 1,
                components: [{
                ...
                },
                {
                    ...
                    rule: {required: true, message: '请选择茶叶品种', type: 'number'},
                    options: []
                },
                {
                    name: 'product_id',
                    ...
                    label: '产品名称',
                    placeholder: '必填',
                    rule: {required: true, message: '请选择产品名称'},
                    options: []
                },
                {
                    name: 'specification',
